...
-(void)DoneButton
{
    ...
    if (!searchDate)
    {
        UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"GeoDay" message:@"Please select date for search." delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles: nil];
        [alert show];
