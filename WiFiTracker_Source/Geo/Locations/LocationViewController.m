...
-(void)addNewLoaction
{
    ...
    loc.isCancelButtonNeeded = YES;
    UINavigationController *navView=[[UINavigationController alloc]initWithRootViewController:loc];
...
//    [self.navigationController pushViewController:loc animated:YES];
    ...
    seachView.isCancelButtonNeed=YES;
